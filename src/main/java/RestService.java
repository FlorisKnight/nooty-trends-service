import controllers.NootController;
import dbal.noots.NootRepo;
import handlers.noots.INootHandler;
import handlers.noots.NootHandler;
...
public class RestService {
    public static void main(String[] args) {
        ...
        INootHandler nootHandler = new NootHandler(new NootRepo());
        NootController.setHandler(nootHandler);
